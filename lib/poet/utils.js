...
function addComment(poet,options, comment){
    if(!poet.comments[comment.slug]){
        poet.comments[comment.slug] = [];
    }
    poet.comments[comment.slug].push(comment);
